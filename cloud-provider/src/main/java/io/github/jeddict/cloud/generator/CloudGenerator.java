...
public final class CloudGenerator extends DockerGenerator implements Generator {
    ...
    private static final String TEMPLATE = "io/github/jeddict/cloud/template/";
    ...
    private void generateKubernetes() {
        if (config.isDockerActivated() && cloudConfig.getKubernetesConfigData().isEnabled()) {
            try {
                ...
                handler.progress(Console.wrap(CloudGenerator.class, "MSG_Progress_Kubernetes_Generating", FG_DARK_RED, BOLD, UNDERLINE));
