...
public class ReactRelationship extends BaseRelationship {

    public ReactRelationship(String appName, String entitySuffix, Entity entity, RelationAttribute relation, String clientRootFolder) {
