 ...
 * @author Gaurav Gupta
 */
public class ReactPanel extends LayerConfigPanel<WebData> {
    ...
    public boolean hasError() {
        ...
        if (StringUtils.isBlank(getPrefix())) {
            warningLabel.setText(NbBundle.getMessage(ReactPanel.class, "ReactPanel.invalidPrefix.message"));
            return true;
        }
        if (StringUtils.isBlank(getModule())) {
            warningLabel.setText(NbBundle.getMessage(ReactPanel.class, "ReactPanel.invalidModule.message"));
            return true;
        }
        if (StringUtils.isBlank(getApplicationTitle())) {
            warningLabel.setText(NbBundle.getMessage(ReactPanel.class, "ReactPanel.invalidTitle.message"));
            return true;
        }
//        if(!JavaUtil.isJava9()){
...
//        }
    ...
    public String getModule() {
        return reactModuleTextField.getText().trim();
    }
    
    private void setModule(String module) {
        reactModuleTextField.setText(module);
    }
    ...
    private void initComponents() {
        ...
        reactModuleLabel = new javax.swing.JLabel();
        reactModuleTextField = new javax.swing.JTextField();
        ...
        org.openide.awt.Mnemonics.setLocalizedText(warningLabel, org.openide.util.NbBundle.getMessage(ReactPanel.class, "ReactPanel.warningLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(prefixLabel, org.openide.util.NbBundle.getMessage(ReactPanel.class, "ReactPanel.prefixLabel.text")); // NOI18N
        prefixLabel.setPreferredSize(new java.awt.Dimension(92, 14));
        jPanel5.add(prefixLabel);

        prefixTextField.setText(org.openide.util.NbBundle.getMessage(ReactPanel.class, "ReactPanel.prefixTextField.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(reactModuleLabel, org.openide.util.NbBundle.getMessage(ReactPanel.class, "ReactPanel.reactModuleLabel.text")); // NOI18N
        reactModuleLabel.setPreferredSize(new java.awt.Dimension(92, 14));
        jPanel3.add(reactModuleLabel);

        reactModuleTextField.setText(org.openide.util.NbBundle.getMessage(ReactPanel.class, "ReactPanel.reactModuleTextField.text")); // NOI18N
        jPanel3.add(reactModuleTextField);

        jPanel1.add(jPanel3);

        wrapperPanel1.setLayout(new java.awt.BorderLayout(10, 0));

        org.openide.awt.Mnemonics.setLocalizedText(appTitleLabel, org.openide.util.NbBundle.getMessage(ReactPanel.class, "ReactPanel.appTitleLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(titleStartLabel, org.openide.util.NbBundle.getMessage(ReactPanel.class, "ReactPanel.titleStartLabel.text")); // NOI18N
        titleStartLabel.setPreferredSize(new java.awt.Dimension(45, 14));
        jPanel2.add(titleStartLabel);

        appTitleTextField.setText(org.openide.util.NbBundle.getMessage(ReactPanel.class, "ReactPanel.appTitleTextField.text")); // NOI18N
        jPanel2.add(appTitleTextField);

        titleEndLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        org.openide.awt.Mnemonics.setLocalizedText(titleEndLabel, org.openide.util.NbBundle.getMessage(ReactPanel.class, "ReactPanel.titleEndLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(clientPackagerLabel, org.openide.util.NbBundle.getMessage(ReactPanel.class, "ReactPanel.clientPackagerLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(protractorTest_CheckBox, org.openide.util.NbBundle.getMessage(ReactPanel.class, "ReactPanel.protractorTest_CheckBox.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(sass_CheckBox, org.openide.util.NbBundle.getMessage(ReactPanel.class, "ReactPanel.sass_CheckBox.text")); // NOI18N
        sass_CheckBox.setToolTipText(org.openide.util.NbBundle.getMessage(ReactPanel.class, "ReactPanel.sass_CheckBox.toolTipText")); // NOI18N
    ...
    private javax.swing.JLabel reactModuleLabel;
    private javax.swing.JTextField reactModuleTextField;
